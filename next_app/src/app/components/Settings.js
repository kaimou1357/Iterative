      ...
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="userSettingsModalLabel">
              User Settings
            </h5>
            <button
              type="button"
          ...
          <div className="modal-body">
            ...
            <div className="mb-3">
              <label htmlFor="color-scheme" className="form-label">
                Color Scheme:
              </label>
              <select
                id="color-scheme"
            ...
            <div className="mb-3">
              <label htmlFor="css-framework" className="form-label">
                CSS Framework:
              </label>
              <select
                id="css-framework"
            ...
            <div className="mb-3 d-flex justify-content-between align-items-center">
              <label htmlFor="show-assistant-messages" className="form-label">
